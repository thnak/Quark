...
public sealed class ReflectionUsageAnalyzer : DiagnosticAnalyzer
{
    ...
    public static readonly DiagnosticDescriptor DynamicTypeResolution = new(
        id: "QRK0001",
        title: "Avoid dynamic type resolution",
        messageFormat: "'{0}' uses dynamic type resolution which is incompatible with Native AOT. " +
    ...
    public static readonly DiagnosticDescriptor DynamicAssemblyLoad = new(
        id: "QRK0002",
        title: "Avoid dynamic assembly loading",
        messageFormat: "'{0}' loads assemblies dynamically which is not supported in Native AOT. " +
    ...
    public static readonly DiagnosticDescriptor ISerializableUsage = new(
        id: "QRK0003",
        title: "Do not use ISerializable",
        messageFormat: "Type '{0}' implements ISerializable which requires DynamicMethod and is " +
