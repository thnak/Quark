...
{
    [ThreadStatic] private static Dictionary<string, object?>? _values;
    ...
    {
        return Values.TryGetValue(key, out object? v) ? v : null;
    }
    ...
    {
        return _values is { Count: > 0 } d ? new Dictionary<string, object?>(d) : new Dictionary<string, object?>();
    }
