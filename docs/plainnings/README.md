...
**Key Features:**
- Saga orchestration and actor queries
- Cloud platform SDKs (Azure, AWS, GCP)
- Additional storage providers (SQL Server, MongoDB, Cassandra, DynamoDB, CosmosDB)
- Message queue integrations (Kafka, RabbitMQ, Service Bus, SQS/SNS, NATS)
- Serverless actors and multi-tenancy support
- Advanced security features and disaster recovery
...
> **📖 For detailed performance targets, community goals, and success metrics, see [ENHANCEMENTS.md](../ENHANCEMENTS.md)**
